...
## Structure
The repository is structured as a Rust workspace revolving around the examples. The examples should be self contained. In case of significant code duplication between examples, this functionality may be factored out into the utils package.